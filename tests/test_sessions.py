...
class TestGetSessionHistory(unittest.TestCase):
    ...
    def test_get_session_history_exists(self, mock_file, mock_glob):
        ...
        mock_file.return_value.__enter__.return_value.read.return_value = json.dumps(session_data)
...
class TestManageSessions(unittest.TestCase):
    ...
    @patch("builtins.open", new_callable=mock_open, read_data='{"sessions": [{"session_id": "test", "model": "llama2"}]}')
